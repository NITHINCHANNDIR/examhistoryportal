...
const Upload = () => {
    ...
    const handleDownloadTemplate = () => {
        const headers = ['studentId', 'examId', 'examName', 'subjectCode', 'subjectName', 'marksObtained', 'marksMaximum', 'grade', 'credits', 'semester', 'academicYear', 'examDate'];
        const sampleRow = ['STU001', 'EXAM2024-001', 'Midterm Examination', 'MATH101', 'Mathematics', '85', '100', 'A', '4', '1', '2023-2024', '2024-03-15'];
